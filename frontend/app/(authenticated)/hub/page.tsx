...
export default function IdentityHubPage() {
  ...
  if (!user) {
    return (
      <div className="max-w-5xl mx-auto py-12 text-center">
        <p className="text-sm text-gray-500">Unable to load user data. Please log in again.</p>
        <button
  ...
  return (
    <div className="max-w-5xl mx-auto py-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900">Identity Hub</h1>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-sm text-gray-500">{disclosureMessage}</span>
        </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      {audit?.status === "in_progress" && (
                        <span className="text-xs bg-amber-50 text-amber-700 px-2 py-0.5 border border-amber-200">
                          In progress
                        </span>
                      )}
                    </div>
      ...
      {completedCount === 5 && (
        <div className="mt-8 bg-white rounded-lg border border-emerald-200 p-6 text-center">
          <div className="inline-flex items-center gap-2 mb-2">
            <svg className="h-5 w-5 text-emerald-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <span className="font-semibold text-emerald-700">All audits complete</span>
          </div>
          <p className="text-sm text-gray-600 mb-4">
